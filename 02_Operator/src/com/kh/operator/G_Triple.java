...
public class G_Triple {
	 ...
	 * [표현법]
	 * 
	 * 조건식 ? 조건식이 TRUE일 경우 결과값 : 조건이 FALSE인 경우의 결과값
	 * 
	 */
	...
	public void method3() {
		...
		System.out.println("영문자 한 개만 입력 : ");
	...
	public void method5() {
		...
		// 두 개의 정수값과 +, -의 문자를 입력받아
		// +인 경우 두 정수값의 덧셈연산한 결과
		// -인 경우 두 정수값이 뺄셈연산한 결과
		// 둘 다 아닌 경우 잘 못 입력했습니다. 출력
		...
		String result = (op == '+') ? (num1 + num2)+"" : (op == '-') ? (num1 - num2)+"" : "잘 못 입력했습니다";
