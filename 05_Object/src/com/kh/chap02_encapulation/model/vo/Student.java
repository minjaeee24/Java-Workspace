...
public class Student {
	...
	// set + 필드명 => 두 단어를 이어줄때 카멜케이스(낙타등 표기법) 활용하여 메소드 명 선언
	public void setName(String name) {
		...
		// 왜? 필드명과 매개변수명이 동일한 경우 {}영역 내에서는 해당 영역에서 만들어진 변수가 좀 더 우선순위가 높기 떄문.
		// 따라서 객체의 name에 접근하려면 this를 사용해야함.
	...
	// get + 필드명(카멜케이스 적용)
	public String getName() { // void : 반환하는 값이 없는 경우에 작성
