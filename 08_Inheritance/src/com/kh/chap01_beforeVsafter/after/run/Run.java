...
public class Run {
	...
	public static void main(String[] args) {
		...
		Desktop d = new Desktop("삼성", "d-01", "삼성데스크탐", 1_500_000, true);
		...
		/*
		 * 실행하고자 하는 메소드라 자식 클래스에 없다면, 자동으로 부모클래스에 있는 메소드가 실행됨.
		 ...
		 * - 명시되어있지 않지만 모든 클래스(말 그대로 모든 클래스)는 Object클래스의 후손
		 * 	=> Object클래스에 있는 메소드를 쓸 수 있다.
		 * 	=> Object클래스에 있는 메소드가 맘에 안 들면 오버라이딩을 통해 재정의가 가능하다.
		 * 
		 */
	}
