...
//		//Desktop d = new Desktop("삼성", "데탑", 800_000, "Geforce 1070");
//		ec.insert(new Desktop("삼성", "데탑", 800_000, "Geforce 1070"));
//		ec.insert(new NoteBook("LG", "그램", 1_500_000, 4));
//		ec.insert(new Tablet("애플", "아이패드", 600_000, true));
//		
//		Desktop d = ec.selectDesktop();
//		NoteBook n = ec.selectNotaBook();
...
//		System.out.println(t);
		...
		ec.insert(new Desktop("삼성", "데탑", 999_999, "Grforce 1070"), 0);
		ec.insert(new NoteBook("엘지", "그램", 2_000_000, 4), 1);
		ec.insert(new Tablet("애플", "아이패드", 500_000, true), 2);
