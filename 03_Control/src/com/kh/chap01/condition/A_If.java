...
public class A_If {
	...
	public void method4() {
		...
		// 어린이(13세 이해), 청소년(13세 초과~ 19세 이해), 성인
		Scanner sc = new Scanner(System.in);
	...
	public void method5() {
		...
		// -> 실행 시 오류남. 위에 String result = "";로 초기화 한 번 해두는게 필수.
	...
	public void method6() {
		 ...
		 * 참조자료형 : String // 특이한녀석
		 * 
		 * 기본자료형간 비교시 == != 사용가능하지만, 참조자료형은 동등비교연산시 정상적으로 연산이 안 됨.
		 * 그럼 어떻게 하냐? 문자열.equals() 라는 방법으로 비교를 함.
		 */
	...
	public void method7() {
		...
		if(num > 0) { // 양수인지 확인
			...
			System.out.println("양수가 아닙니다. 잘 못 입력하셨습니다.");
			method7();
		}
