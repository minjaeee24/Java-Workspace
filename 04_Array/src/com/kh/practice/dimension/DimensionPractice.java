...
//		출력 후 다시 정수를 받게 하세요. 크기가 정해진 이차원 배열 안에는 영어 대문자가 랜덤으로 들어가게 한 뒤 출력하세요. 
//		(char형은 숫자를 더해서 문자를 표현할 수 있고 65는 A를 나타냄)
//		ex.
//		행 크기 : 5 열 크기 : 4 TPMB UIHS QMBH HBI X GFXI
...
//		7. 송성실 8. 윤예의 9. 진재주 10. 차천축 11. 피풍표 12. 홍하하
		...
		String[] arr = {"강건강","남나나","도대남","류라라", "문미미", "박보배", "송성실",
				"윤예의", "진재주", "차천축", "피풍표", "홍하하"};
