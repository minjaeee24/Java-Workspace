package com.kh.chap02_string.controller;
	...
	// 수정하는 순간 기존의 값이 담겨있는 공간에서 수정되지 않음. (새로운 주소값 할당)
public class A_StringPoolTest {
	...
	public void method1() {
		...
		// 정말 주소값을 알고 싶을 때 사용하는 메소드 System.identityHashCode(참조변수(레퍼런스변수));
	...
	public void method3() {
		 ...
		 * 불변이라고 해서 수정이 아예 안 되는게 아니라
		 * 기존의 그 자리(원래 있던 주소값)에서 수정되는 개념이 아니라는것.
		 * 매번 새로운 주소값을 참조하게 됨.
		 * 
		 */
