...
public class C_Cast {
	 ...
	 *  
	 *  2. 강제(명시적)형변환	=> 자동형변환이 되지 않아 내가 직접 강제로 형변환을 해야 하는 경우
	 *  					=> 큰바이트의 자료형 -> 작은바이트의 자료형
	 *  
	 *  [표현법] (바꿀자료형) 값;
	 *  
	 *  (바꿀자로형) == 형변환연산자 == cast 연산자
	 *  
	 *  ** boolean은 형변환 불가.
	 * 
	 */
	...
	public void autoCasting() {
		...
		/*
		 * char의 범위 0~65xxx : 각 문자마다 고유의 정수값이 정해져있다.
		 * 따라서 쌍방향 형변환이 가능하다.
		 * 음수값음 오류가 난다.
		 * 참고 : 아스키코드표(0~127, 영문자 대소문자, 숫자, 특수문자)
		 * 		 유니코드표(0~65xxx, 영어, 숫자, 특수문자, 한글, 그 외 언어)
		 */
		System.out.println((int)'김');
		
		char sum = 'A'+10 ; //65 +10 문자와 정수 사이의 연산이 가능하다.
	...
	public void forceCasting() {
		...
		// iNumdl double형으로 우선 변환이 됨. 10 -> 10.0
		...
		//			 자동형변환은 작은 바이트변수가 큰 바이트 변수로 형변환되기 때문데
		...
		// 해결방법3. 애초에 결과값을 double형 변수에 담기 (데이터 손실 없이 정확한 값이 담김)
