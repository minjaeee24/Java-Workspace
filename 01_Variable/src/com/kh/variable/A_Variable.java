...
public class A_Variable {
	...
	public void printVariable() {
		...
		System.out.println("김민재 : " + (11000 * 4 * 5) + "원 입니다.");
		System.out.println("홍길동 : " + (11000 * 7 * 20)+ "원 입니다.");
		System.out.println("고길동 : " + (11000 * 8 * 23)+ "원 입니다.");
		
		System.out.println("변수 사용 후");
		int pay = 11000; // 자바에서 =은 대입을 나타내는 연산자입니다. 같다는 ==을 사용함.
		int time = 7;
		int day = 15;
		...
		// 변수를 사용하여 월급 측정(시근 * 근무시간 * 근무일)
		System.out.println("김민재 : " + (pay * time * day) + "원 입니다.");
		System.out.println("홍길동 : " + (pay * time * day) + "원 입니다.");
		System.out.println("고길동 : " + (pay * time * (day+5)) + "원 입니다.");

		/*
		 * 변수를 사용하는 이유
		 * 1. 변수는 우선적으로 값에 의의를 부여할 목적으로 사용 (가독성이 좋음)
	...
	public void declareVariable() {
		/*
		 * 변수의 건언(값을 기록하기 위한 변수를 메모리 공간에 확보해두겠다 = 박스를 만들겠다)
		 * [표현볍] 자료형 변수명;
		 * 
		 * 자료형 : 어떤 값을 담아낼지, 어떤 크기의 값을 담아낼지에 따라서 변수의 크기 및 모양
		 * 울 지정하는 부분.
		 * 변수명 : 변수의 이름을 정하는 부분.
		 * 
		 * 주의할점
		...
		// 실수형 중 가장 대표적인 자료형 => 보다 정확한 실수값을 담을 수 있기 때문에.
