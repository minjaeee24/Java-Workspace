...
public class ConsumerTest {
	 ...
	 * 2. 매개변수가 있고 리턴값은 없다.
	 * 3. 내부적으로 accept()메소드 한 개만 구현되지 않은 형태로 존재
	 * 
	 */
	...
	public static void main(String[] args) {
		c1.accept("갤럭시 z플립4");
		c2.accept(40_000);
		c3.accept("갤럭시 z플립4", 1_350_000);
		c4.accept(new Product("갤럭시 z플립4", 0, 1), 1_350_000);
