...
public class Run {
	/*
	 * 람다식이란? 익명함수(제목이 없는 함수)처럼 구동됨. (java8버전 이후부터 사용 가능)
	 * 실제로는 익명구현객체(이름없는 클래스)를 생성하여 내부에 내가 작성한 코드를 실행시키는 방식으로 구동함.
	 * 
	...
	public static void main(String[] args) {
		...
		lamda4 l4 = a -> a*a; // 매개변수가 하나면 () 생략 가능, 코드가 단순 return문이 끝이면 {} 생략 가능.
